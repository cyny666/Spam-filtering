...
import time
import datetime
from cnn_mailclassify import data_helpers
from cnn_mailclassify import word2vec_helpers
from cnn_mailclassify.text_cnn import TextCNN
import csv


def eval():
    tf.flags.DEFINE_string("input_text_file", ".\\mail_content.csv", "Test text data source to evaluate.")
